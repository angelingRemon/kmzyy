...
<script>
	export default {
		data() {
			...
			goDoc(id,DeptName){
				this.$utils.skipPage("navigateTo", this.$api.sp.clinic+"?DeptCode="+id+"&DeptName="+DeptName);
			},
			loadData(){
				uni.showLoading({
					title:"加载中...",
